...
# df_mean_sd = df %>% group_by(line, sex, treat, batch) %>% summarise(mean = mean(na.omit(d78weight)), sd = sd(na.omit(d78weight)))
# df_mean_sd

# df["d8weight"][df["ID"] == 7090] %in% df_mean_sd[(df_mean_sd["line"]=="A" & df_mean_sd["sex"]=="M" & df_mean_sd["treat"]=="Genistein")]
```
